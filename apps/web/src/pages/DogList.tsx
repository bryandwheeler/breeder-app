          ...
          <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col'>
              ...
              {isGuardian && row.original.guardianHome && (() => {
                const guardianInfo = getGuardianContactInfo(row.original.guardianHome, customers);
                return (
                  <div className='text-xs'>
                    {guardianInfo && guardianInfo.id ? (
                      <a
                        href={`/customers?view=${guardianInfo.id}`}
                      ...
                      <span className='text-muted-foreground'>{guardianInfo.name}</span>
                    ) : null}
                    {' '}
