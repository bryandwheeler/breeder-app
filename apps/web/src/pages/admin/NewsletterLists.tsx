/**
 * Admin Newsletter Lists Management
 *
...
export function NewsletterLists() {
  ...
  useEffect(() => {
    ...
    const unsub = subscribeLists(currentUser.uid, 'admin');
    return () => unsub();
  }, [isAdmin, currentUser, subscribeLists]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Subscriber Lists</h1>
                ...
                {lists.map((list) => (
                  <TableRow key={list.id}>
                    <TableCell>
                      <div>
                        <Link
                          to={`/admin/newsletter/subscribers?list=${list.id}`}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link to={`/admin/newsletter/subscribers?list=${list.id}`}>
