...
import { GuardianHome } from '@/types/dog';
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setGuardian({ ...guardian, guardianName: e.target.value })
                }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setGuardian({ ...guardian, address: e.target.value })
                }
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button onClick={handleSave} disabled={!guardian.guardianName}>
              Save Guardian Info
            </Button>
          </div>
        </div>
