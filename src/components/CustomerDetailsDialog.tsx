...
import { Customer, Interaction, Purchase, ContactRole } from '@/types/dog';
        ...
        <Tabs defaultValue='profile' className='space-y-4'>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value='facebook_msg'>
                          Facebook Message
                        </SelectItem>
                        <SelectItem value='tiktok_msg'>
                          TikTok Message
                        </SelectItem>
                    ...
                    <Card key={interaction.id} className='p-4'>
                      <div className='flex items-start justify-between'>
                        ...
                        <Button
                          ...
                          size='sm'
                          onClick={() =>
                            deleteInteraction(customer.id, interaction.id)
                          }
                        >
                  ...
                  <Card key={purchase.id} className='p-4'>
                    <div className='flex items-start justify-between'>
                      <div className='flex-1'>
                        ...
                        <div className='font-medium mb-1'>
                          {purchase.puppyName || 'Unnamed Puppy'}
                        </div>
                        <div className='text-sm'>
                          <span className='font-medium'>Amount:</span>{' '}
                          {formatCurrency(purchase.amount)}
                          {purchase.depositAmount &&
                            purchase.depositAmount > 0 && (
                              <span className='text-muted-foreground'>
                                {' '}
                                (Deposit:{' '}
                                {formatCurrency(purchase.depositAmount)})
                              </span>
                            )}
                        </div>
                      </div>
          ...
          <TabsContent value='settings' className='space-y-6'>
            ...
            <div className='space-y-2'>
              <h4 className='font-semibold text-sm'>Contact Types</h4>
          ...
          <TabsContent value='messaging' className='space-y-6'>
            <div className='space-y-4'>
              <div className='flex items-center justify-between'>
                <h3 className='font-semibold'>Instagram & Social Media</h3>
                ...
                <Card className='p-4'>
                  <div className='flex items-center gap-3 mb-3'>
                    <div className='h-12 w-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center'>
                      {customer.instagramProfilePicture ? (
                        <img
                          src={customer.instagramProfilePicture}
                          alt={customer.instagramUsername}
                  ...
                  {customer.instagramSenderId && (
                    <div className='text-xs text-muted-foreground'>
                      Connected • Can receive DMs
                    </div>
                  )}
                </Card>
              )}
                    ...
                    <div className='grid grid-cols-3 gap-3'>
                      <Card className='p-3'>
                        ...
                        <div className='text-2xl font-bold'>
                          {customer.conversationIds.length}
                        </div>
                      </Card>
                      {customer.unreadMessageCount !== undefined && (
                        <Card className='p-3'>
                          <div className='text-xs text-muted-foreground'>
                            Unread
                          </div>
                ...
                (!customer.conversationIds ||
                  ...
                  <Card className='p-8 text-center'>
                    ...
                    <p className='text-muted-foreground'>
                      No messaging information available
                    </p>
                    <p className='text-sm text-muted-foreground mt-1'>
                      Instagram conversations will appear here once the customer
                      messages you
                    </p>
                  </Card>
                )}
              ...
              {customer.instagramUsername && (
                <div className='pt-4 border-t'>
                  ...
                  <div className='flex gap-2 mt-2'>
                    <Button variant='outline' size='sm' asChild>
                      <a
                        href={`/messaging?contact=${customer.id}`}
                        target='_blank'
                        rel='noopener noreferrer'
                      >
                        <MessageSquare className='h-4 w-4 mr-2' />
